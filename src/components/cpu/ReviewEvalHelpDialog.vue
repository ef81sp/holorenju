    ...
    <div class="help-content">
      ...
      <div class="help-body">
        <section class="help-section">
          <h3>スコアと品質</h3>
          <p>
            コンピュータが数手先まで読み、各候補手を評価したスコアです。最善手とのスコア差に基づいて手の品質が決まります。
          </p>
          <ul>
            <li>
              <strong>最善手</strong>
        ...
        <section class="help-section">
          <h3>候補手</h3>
          <p>
            コンピュータが探索した候補手の上位5手をスコア順に表示します。実際に打った手が上位5手に含まれない場合は「ランク外」として末尾に追加されます。
          </p>
        </section>
        ...
        <section class="help-section">
          <h3>末端比較</h3>
          <p>
            最善手と実際の手それぞれについて、コンピュータが予想する数手先の盤面（読み筋の末端）でのパターンを比較します。差がある項目のみ表示されます。
          </p>
          <ul>
            <li>
              <strong>自分</strong>
