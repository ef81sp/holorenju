...
`src/logic/cpuAI/minimax.ts` で Iterative Deepening + Alpha-Beta剪定 + Transposition Table を実装済み。
...
| 1      | 動的時間配分       | 低         | 高       |
| 2      | LMR                | 中         | 高       |
| 3      | Aspiration Windows | 中         | 中       |
| 4      | Futility Pruning   | 中         | 中       |
| 5      | Null Move Pruning  | 高         | 低       |
