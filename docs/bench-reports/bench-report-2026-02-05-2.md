...
**注目点**: beginnerの禁手負けが増加（3回→5回）。mediumがbeginnerに禁手負けするケース（game31）は調査済み（下記）。

### 禁手負け game31 の詳細（調査完了）

```
medium(黒) vs beginner(白), 15手で終了
棋譜: H8 G8 J7 L9 I7 G9 G7 F7 J8 H9 I10 F9 E9 J9 I9(禁手)
```

**分析結果**: 正当な「禁手追い込み」による白の勝利

| 手番 | 着手 | 状況                                         |
| ---- | ---- | -------------------------------------------- |
| 12   | F9   | 白の活三が2つ（I9, E9）                      |
| 13   | E9   | 黒がE9に防御                                 |
| 14   | J9   | 白が止め四（F9-G9-H9-J9）を形成              |
| 15   | I9   | 黒の唯一の防御手I9が三三禁手 → 禁手追い込み成立 |

**結論**: CPUのバグではなく、連珠の正式な戦術（禁手追い込み）が成立したケース。beginner（白）がたまたま禁手追い込みの形を作れたため、medium（黒）に勝利。
...
2. ~~**禁手負け追跡**: game31（medium vs beginner）の詳細調査~~ → **完了**: 正当な禁手追い込みと判明
